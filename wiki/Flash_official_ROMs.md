...
1. Download and unzip XiaomiADB from [here](Tools_for_Xiaomi_devices).
...
**Requirements:** [unlocked bootloader](Unlock_the_bootloader)

1. Download the Xiaomi ADB/Fastboot Tools from [here](Tools_for_Xiaomi_devices).
...
4. Connect the device to your PC and enter EDL mode by following the instructions [here](Access_EDL_mode).
